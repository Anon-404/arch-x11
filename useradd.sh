...
pkgInstaller(){
    ...
    for i in wget curl fish neofetch git base-devel exa starship bat fzf pkgfile
    do
         echo ""
...
confterm(){
	...
	rm -rf /home/$user/.bashrc /etc/bash.bashrc /home/$user/.config/fish/config.fish
	wget https://raw.githubusercontent.com/Anon-404/My-assets/main/archlinux/config.fish -O /home/$user/.config/fish/config.fish
	wget https://raw.githubusercontent.com/Anon-404/My-assets/main/archlinux/bash.bashrc -O /etc/bash.bashrc
	wget https://raw.githubusercontent.com/Anon-404/My-assets/main/archlinux/bash.bashrc -O /home/$user/.bashrc
